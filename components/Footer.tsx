...
function Footer() {
  ...
  return (
    <footer className="w-full  border-top border-top-2   px-3 md:mt-16">
      ...
      >
        <h2 className="text-2xl w-full text-center mb-5 font-bold text-purple-400">
        ...
        <input
          ...
          type="email"
          value={email}
          className="w-[80%] border  rounded-l-md  my-1 bg-transparent  outline-none  pl-5 py-4 text-lg"
        ...
        {isLoading ? (
          <button
            type="button"
            className="px-2 flex items-center justify-center text-2xl rounded-r-md border-2 border-purple-400  w-[20%] py-4 outline-none  max-w-3xl  text-zinc-100 font-semibold hover:bg-purple-500 transition-all ease-in-out bg-purple-400  "
          >
            <svg
              aria-hidden="true"
